...
/**
 * Unified manager for Corese Graph operations. Consolidates functionality previously split between
 * DataManager and GraphManager.
 *
 * <p>Capabilities: - Manage the singleton Graph instance. - Load data from Files and URLs. - Clear
 * the graph. - Export the graph to files or strings.
 */
