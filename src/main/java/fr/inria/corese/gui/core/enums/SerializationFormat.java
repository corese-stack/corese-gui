 ...
 * query results, providing consistent format labels and file extensions across
 * the application.
 *
 * <p>
 * <b>Usage example:</b>
...
public enum SerializationFormat {
	...
	TURTLE("Turtle", ".ttl"), RDF_XML("RDF/XML", ".rdf"), JSON_LD("JSON-LD", ".jsonld"), N_TRIPLES("N-Triples",
			".nt"), N_QUADS("N-Quads", ".nq"), TRIG("TriG",
					".trig"), RDFC10("RDFC-1.0", ".nq"), RDFC10_SHA384("RDFC-1.0 (SHA-384)", ".nq"),

	// SPARQL Result Formats
	CSV("CSV", ".csv"), TSV("TSV", ".tsv"), JSON("JSON", ".json"), XML("XML", ".xml"), MARKDOWN("Markdown", ".md"),
	 ...
	 *
	 * @param extension
	 *            The file extension (e.g., ".ttl", "rq") - case insensitive, with
	 *            or without dot
