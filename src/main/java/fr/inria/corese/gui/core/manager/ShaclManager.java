...
/**
 * Manager for SHACL validation operations. Handles the interaction with Corese SHACL validator and
 * result formatting.
 */
public class ShaclManager {
  ...
  public List<ValidationReportItem> extractReportItems(ValidationResult result) {
    ...
    try {
      ...
      for (var mapping : map) {
        String severity =
            mapping.getValue("?severity") != null ? mapping.getValue("?severity").getLabel() : "";
        String focusNode =
            mapping.getValue("?focusNode") != null ? mapping.getValue("?focusNode").getLabel() : "";
        String resultPath =
        ...
        String message =
            mapping.getValue("?message") != null ? mapping.getValue("?message").getLabel() : "";
