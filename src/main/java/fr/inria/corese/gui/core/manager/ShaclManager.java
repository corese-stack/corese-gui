...
public class ShaclManager {
    ...
    /**
     * Formats the report graph into the specified format.
     *
     ...
     */
    public String formatReport(ValidationResult result, String format) {
        if (result == null || result.getReportGraph() == null || format == null) {
            return null;
        }
        ...
        return QueryManager.getInstance().formatGraph(result.getReportGraph(), coreseFormat);
    }
