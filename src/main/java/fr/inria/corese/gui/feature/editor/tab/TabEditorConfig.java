 ...
 *
 * <p>
 * This class consolidates all configuration parameters for the TabEditor,
 * replacing multiple configure() methods with a single immutable configuration
...
public class TabEditorConfig {
	...
	private final Runnable templateAction;
	...
	private TabEditorConfig(Builder builder) {
		...
		this.templateAction = builder.templateAction;
	...
	public Runnable getTemplateAction() {
	 ...
	 *
	 * @return A supplier that creates new ResultController instances, or null if
	 *         not configured
	 */
	...
	public static class Builder {
		...
		private Runnable templateAction;
		// Legacy extension point kept for backward compatibility.
		...
		public Builder withTemplateAction(Runnable action) {
