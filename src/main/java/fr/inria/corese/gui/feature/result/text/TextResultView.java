 ...
 * Features:
 * <ul>
 * <li><b>Code Editor:</b> Uses {@link CodeMirrorWidget} for syntax highlighting
 * and read-only display.
 * <li><b>Format Selector:</b> A floating dropdown to switch between
 * serialization formats.
 * <li><b>Toolbar:</b> Sidebar for common actions (Copy, Export, Zoom).
 * </ul>
 *
 * <p>
 * Design Note: The format selector overlays the editor content in the top-right
 * corner to save space, fading out when not in use.
 */
