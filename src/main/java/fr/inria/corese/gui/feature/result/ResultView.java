 ...
 * <li>Getters have package-private visibility to encourage proper API
 * usage</li>
 * </ul>
 */
public class ResultView extends AbstractView {
	...
	// ==============================================================================================
	// These getters have package-private visibility to discourage direct
	// manipulation
	// of tabs from outside the view package. Controllers should use high-level
	// methods
	...
	/**
	 * Clears all tabs from the tab pane. This method encapsulates the internal
	 ...
	 *
	 * @param content
	 *            The JavaFX node to display in the text tab
	 */
	 ...
	 *
	 * @param content
	 *            The JavaFX node to display in the table tab
	 */
	 ...
	 *
	 * @param content
	 *            The JavaFX node to display in the graph tab
	 */
	 ...
	 *
	 * <p>
	 * This method encapsulates the internal tab selection logic.
	 */
	 ...
	 *
	 * @param tab
	 *            The tab to enable/disable (use getTextTab(), getTableTab(), etc.)
	 * @param enabled
	 ...
	 *
	 * <p>
	 * This method provides controlled access to individual tabs for configuration
	 * purposes (e.g., enabling/disabling) while keeping the internal tab references
	 * encapsulated.
	 *
	 * @param tabType
	 *            The type of tab to retrieve
