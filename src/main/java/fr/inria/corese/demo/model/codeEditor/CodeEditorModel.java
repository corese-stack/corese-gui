...
public class CodeEditorModel {
    ...
    public void setModified(boolean modified) { this.modified.set(modified); }
    public String getDisplayName() { return displayName.get(); }
    public QueryResult getLastQueryResult() { return lastQueryResult; }
    public void setLastQueryResult(QueryResult result) { this.lastQueryResult = result; }
}